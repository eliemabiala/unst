 ...
 */
final class Version20241025173215 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE messages ADD author_id INT NOT NULL, ADD conversation_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE messages DROP author_id, DROP conversation_id');
    }
}
